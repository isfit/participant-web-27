  ...
  return (
    <div className={styles.homePage}>
      ...
      <div className={styles.centerContainer}>
        <img src={'../../../public/images/Isfitlogo_power_white_version2.png'} alt="Logo" className={styles.logo} />
        <br />
      ...
      <img
      src='../../../public/images/Isfitlogo_power_white_version2.png'
      alt="Logo"
    ...
    />
      <div className={styles.footerLine1}>
        ...
        <div className={styles.footerRight}>
          <a href="https://www.facebook.com/ISFiT" className={styles.footerLink} target="_blank" rel="noopener noreferrer">
            <img src={'../../../public/images/facebook.png'} alt="Facebook" className={styles.socialIcon} /> Facebook
          </a>
          <a href="https://www.instagram.com/isfitfestival" className={styles.footerLink} target="_blank" rel="noopener noreferrer">
            <img src={'../../../public/images/instagram.png'} alt="Instagram" className={styles.socialIcon} /> Instagram
          </a>
          <a href="https://twitter.com/ISFiT" className={styles.footerLink} target="_blank" rel="noopener noreferrer">
            <img src={'../../../public/images/x-logo.jpg'} alt="Twitter" className={styles.socialIcon} /> X
          </a>
        </div>
      </div>
      ...
      <div className={styles.footerLine3}>
        <img src={'../../../public/images/ntnu.png'} alt="NTNU" className={styles.partnersIcon} />
        <img src={'../../../public/images/sit.png'} alt="sit" className={styles.partnersIcon} />
        <img src={'../../../public/images/kjeldsberg.png'} alt="kjelsberg" className={styles.partnersIcon} />
      </div>
      <div className={styles.footerLine4}>
        <img src={'../../../public/images/moller.png'} alt="Moller" className={styles.partnersIcon} />
        <img src={'../../../public/images/trøndelagkommune.png'} alt="Trøndelagkommune" className={styles.partnersIcon} />
        <img src={'../../../public/images/kommune.png'} alt="Trondheim Kommune" className={styles.partnersIcon} />
      </div>
      <div className={styles.footerLine5}>
      <img src={'../../../public/images/Kilroy.png'} alt="Kilroy" className={styles.partnersIcon} />
        <img src={'../../../public/images/vaernes.png'} alt="Vaernes" className={styles.partnersIcon} />
