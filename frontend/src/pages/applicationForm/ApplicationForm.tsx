...
const ApplicationForm: React.FC = () => {
  ...
  const personalDetails: { label: string; name: keyof FormValues; type: string; options?: string[]; placeholder?: string; required?: boolean; }[] = [ { label: 'Full Name', name: 'fullName', type: 'text', placeholder: 'John Doe', required: true },
  ...
  const themeSection: { label: string; name: keyof FormValues; type: string; options?: string[]; placeholder?: string; required?: boolean; }[] = [ { label: "When considering the theme of 'POWER' for ISFiT25, what aspects or dimensions of power come to your mind first?", name: 'themePowerThoughts', type: 'textarea', placeholder: 'When I think of power I think of ...', required: true },
  ...
  const workshopSection: { label: string; name: keyof FormValues; type: string; options?: string[]; placeholder?: string; required?: boolean; }[] = [ { label: 'Select your first priority', name: 'firstPriority', type: 'text', placeholder: 'Your first priority', required: true },
  ...
  const financialSupportSection: { label: string; name: keyof FormValues; type: string; options?: string[]; placeholder?: string; required?: boolean; }[] = [  { label: 'Some of the participants get financial support for their trip to participate in ISFiT25. Why do you think that you should be considered for this financial support?', name: 'financialSupportReason', type: 'textarea', placeholder: 'I should be considered to get financial support because ...' },
  ...
  const consentSection: { label: string; name: keyof FormValues; type: string; options?: string[]; placeholder?: string; required?: boolean; }[] = [  { label: 'I have to apply for a visa if I get accepted as a participant', name: 'consentVisa', type: 'checkbox', required: true },
